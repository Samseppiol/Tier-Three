...
class DevelopersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create developer" do
    assert_difference('Developer.count') do
      post developers_url, params: { developer: { description: @developer.description, location: @developer.location, price: @developer.price, rating: @developer.rating, user_id: @developer.user_id } }
    end
  ...
  test "should update developer" do
    patch developer_url(@developer), params: { developer: { description: @developer.description, location: @developer.location, price: @developer.price, rating: @developer.rating, user_id: @developer.user_id } }
